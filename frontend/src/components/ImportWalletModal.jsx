...
const stepsBox = {
  ...
  border: "1px solid #333",
  // CHANGED: this box is always dark, but it can now be placed inside
  // either a dark card (Sign In's MetaMask reconnect step) or a white
  // one (Register, after signup) — an explicit color here means its
  // text is never at the mercy of whichever ancestor it lands in.
  color: "#e5e5e5",
};
